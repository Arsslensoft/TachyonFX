...
namespace Devsense.PHP.Syntax.Ast
{
    ...
    /// <summary>
    /// Represents <c>autoload</c> expression.
    /// </summary>
    public sealed class AutoloadEx : Expression
    {
      

        public override Operations Operation => throw new NotImplementedException();

   

        public AutoloadEx(Text.Span span)
            : base(span)
        {
