...
class DataMappingManager
{
    ...
    /**
     * Initializes the EmeraldObjectRelationalModel using a given connection or a created one
     *
     * @access public
     * @static
    ...
    public static function initializeMapper($conn = null)
    {
        ...
        EmeraldObjectRelationalModel::useConnection($conn, $GLOBALS["tachyon_config"]["mysql_database"]);
