...
class EmeraldObjectRelationalModel extends SerializableModel

{
     ...
     * @return mixed
     */
    public static function sql($sql, $query_values = null , $return = EmeraldObjectRelationalModel::FETCH_MANY)
    {
        // shortcuts
        ...
        if ($return === EmeraldObjectRelationalModel::FETCH_NONE)
            return;
    ...
    {
        $count = self::sql($sql,null, EmeraldObjectRelationalModel::FETCH_ONE);
    ...
    {
        self::sql('TRUNCATE :database.:table',null, EmeraldObjectRelationalModel::FETCH_NONE);
    }
    ...
    public static function retrieveByPK ($pk)
    {
        ...
        return $reflectionObj->newInstanceArgs(array($pk, EmeraldObjectRelationalModel::LOAD_BY_PK));
    }
    ...
    public static function hydrate ($data)
    {
        ...
        return $reflectionObj->newInstanceArgs(array($data, EmeraldObjectRelationalModel::LOAD_BY_ARRAY));
    }
     ...
     * @return mixed
     */
    public static function retrieveByField ($field, $value, $return = EmeraldObjectRelationalModel::FETCH_MANY)
    {
