...
class Mailer
{
     ...
     * @var array
     * @access protected
     * @see Mailer::$to @see Mailer::$cc @see Mailer::$bcc
     */
     ...
     * Uses the MailerSMTP class by default.
     * @see Mailer::getSMTPInstance() to use a different class.
     * @param string $header The message headers
     * @param string $body The message body
     * @throws MailerException
     * @uses SMTP
    ...
    public function createHeader()
    {
        ...
        if ($this->XMailer == '') {
            $result .= $this->headerLine(
                'X-Mailer',
                'Mailer ' . $this->Version . ' (https://github.com/Mailer/Mailer)'
            );
        } else {
     ...
     *    or your own custom converter @see Mailer::html2text()
